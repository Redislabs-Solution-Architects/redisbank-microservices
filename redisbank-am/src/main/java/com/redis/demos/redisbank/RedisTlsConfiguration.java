...
public class RedisTlsConfiguration {
	...
	/*
	 * This method creates the connection factory to connect to the transactions
	 * event bus (Redis, can be A-A)
	 */
	@Bean
	...
	/*
	 * This method creates a client to connect to the local database (Redis, has
	 * TimeSeries, so preferably no A-A)
	 */
